...
setup_dir_lsd = "/nrs/saalfeld/heinrichl/fly_organelles/lsd/networks/hemi/lsd"
checkpoint_lsd = "train_net_checkpoint_200000"
input_tensor_lsd = ["raw"]
output_tensor_lsd = ["embedding"]
session_lsd = load_eval_model(setup_dir_lsd, checkpoint_lsd)

setup_dir_acrlsd = "/nrs/saalfeld/heinrichl/fly_organelles/lsd/networks/hemi/acrlsd"
checkpoint_acrlsd = "train_net_checkpoint_200000"
